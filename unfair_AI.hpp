#ifndef UNFAIR_AI_HPP_INCLUDED
#define UNFAIR_AI_HPP_INCLUDED
...
int unfair_artificial_intelligence(Board &boarding_map, int i, string player, string ai, int input) {
    int randomness;
    switch(i) {
        case 0:
